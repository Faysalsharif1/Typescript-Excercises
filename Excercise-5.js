...
new variable called message. Print your messag*/
let famous_person = "Quaid-e-Azam";
let message = famous_person + ` once said, "Think 100 times before you take a decision, but when you take a decision stand by it as one man."`;
console.log(message);
export {};
